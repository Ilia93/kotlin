package com.example.pocketbook.presentation.screen.search.books_styles
...
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_ADVENTURE
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_CHILDREN
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_CLASSICAL
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_DETECTIVE
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_FICTION
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_FOREIGN
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_HISTORY
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_NOVEL
import com.example.pocketbook.presentation.screen.search.SearchScreenFragment.Companion.CATEGORY_UTOPIA
import com.example.pocketbook.presentation.screen.search.book_category.CategoryFragment
import com.example.pocketbook.presentation.screen.search.books_styles.recycler_view.BooksStylesAdapter
import com.example.pocketbook.presentation.screen.search.books_styles.recycler_view.BooksStylesDataClass
